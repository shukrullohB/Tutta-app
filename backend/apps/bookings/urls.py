...
from .views import BookingCancelView, BookingCompleteView, BookingConfirmView, BookingListCreateView
...
urlpatterns = [
    ...
    path('<int:pk>/complete', BookingCompleteView.as_view(), name='bookings-complete'),
]
